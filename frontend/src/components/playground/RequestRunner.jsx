...
function TelemetryCard({ icon, label, value, valueClass = 'text-gray-200', sublabel, glowClass = '' }) {
  return (
    <div className="flex flex-1 flex-col gap-1.5 rounded-xl border border-gray-800/80
      ...
      {/* Sublabel */}
      {sublabel && (
        <p className="truncate text-xs text-gray-600">{sublabel}</p>
      )}
    </div>
  );
}
    ...
    <div className="flex flex-col gap-3 animate-slide-up">
      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
        ...
        <TelemetryCard
          ...
          value={lm.label}
          valueClass={lm.color}
          sublabel={latency != null ? (latency < 50 ? 'Excellent' : latency < 200 ? 'Good' : latency < 600 ? 'Moderate' : 'Slow') : undefined}
        />
  ...
  return (
    <div className="card flex flex-col gap-4">
      ...
      {!activeEndpoint ? (
        ...
        <>
          {/* ── Method + URL bar ──────────────────────────────────────────── */}
          <div className="flex items-center gap-2 rounded-lg border border-gray-700
                          bg-gray-800/60 p-1">
            <select
              className={`shrink-0 rounded-md border-0 bg-gray-800 px-2 py-1.5 font-mono
                         text-xs font-bold focus:outline-none focus:ring-1 focus:ring-brand-500
            ...
            <code className="flex-1 truncate text-xs text-gray-400 pr-1" title={url}>
              {url}
            </code>
          </div>
          ...
          {['POST', 'PUT', 'PATCH'].includes(method) && (
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                className="input min-h-[80px] resize-y font-mono text-xs text-gray-300
            ...
            <div className="flex flex-col gap-4">
              ...
              {response !== null && response !== undefined && (
                <div className="flex flex-col gap-1.5 animate-fade-in">
                  ...
                  <div
                    className="max-h-72 overflow-y-auto rounded-xl border border-gray-800
                               bg-gray-950/80 px-4 py-3"
                    role="region"
